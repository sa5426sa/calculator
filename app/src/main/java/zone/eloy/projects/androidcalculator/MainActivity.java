...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener
{
    ...
    private boolean addOperand(String operand)
    {
        ...
        if (operationLength > 0)
        {
            ...
            {
                Toast.makeText(getApplicationContext(), "Cannot enter two operands at the same time", Toast.LENGTH_LONG).show();
        ...
        {
            Toast.makeText(getApplicationContext(), "Cannot enter operand by itself", Toast.LENGTH_LONG).show();
        }
        return done;
    }
    ...
    private void calculate(String input)
    {
        ...
        {
            Toast.makeText(getApplicationContext(), "Wrong format or attempted division by zero", Toast.LENGTH_LONG).show();
            return;
        }
